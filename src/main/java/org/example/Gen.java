...
public class Gen
{
    ...
    private double beta;
    private int sign_law;
    private int lambda_law;
    private int variant;
    private int schema;
    public Gen() {
    ...
    public Gen(double[][] a, double[][] a_inv, int n, double alpha, double beta, int sign_law, int lambda_law, int variant, int schema) {
        this.a = a;
        this.a_inv = a_inv;
        this.n = n;
        this.alpha = alpha;
        this.beta = beta;
        this.sign_law = sign_law;
        this.lambda_law = lambda_law;
